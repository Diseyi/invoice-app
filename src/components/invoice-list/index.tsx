    ...
    return (
        <div className="bg-white dark:bg-black-shade-2 border rounded-xl w-full">
            <div className="hidden md:grid grid-cols-6 items-center  w-full px-5 py-4 ">
                ...
                <div className="border text-left text-gray-purple text-sm dark:text-white"> Due {paymentDue} </div>
                <div className="border text-gray-purple text-sm dark:text-white">{clientName} </div>
                <div className="border font-semibold dark:text-white"> $ {total} </div>
                ...
                <div className="border w-12 flex items-center justify-end ">
